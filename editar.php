  ...
  ?>
    <form action="edit.php?id=<?php echo $dat->id; ?>" method="post">
        <div class="mb-3">
            ...
            <div>   
            <label  class="form-label">Nombre de Producto</label><br>
            <input type="text" class="form-control" name="nombre" value="<?php echo $dat -> nombre_de_producto;?> " placeholder="">
          </div>
          <div class="mb-3">
            <label  class="form-label">Descripcion de Producto</label><br>
            <input type="text" class="form-control" name="descripcion" value="<?php echo $dat -> descripcion_de_producto;?> " placeholder="">
          </div>
          <div class="mb-3">
            <label  class="form-label">Precio</label><br>
            <input type="number" class="form-control" name="precio" value="<?php echo $dat -> precio;?>" placeholder="">
          </div>
          <div class="mb-3">
            <label  class="form-label">Cantidad</label><br>
            <input type="number" class="form-control" name="cantidad" value="<?php echo $dat->cantidad;?>"placeholder="">
